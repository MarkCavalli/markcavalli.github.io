    ...
    return (
        <div className={styles.main}>
            <p className={styles.p}>
                ...
                a member of the International House World Organization and an approved Cambridge and IELTS examination center. This is my first job as a front-end developer.
                ...
                The company also had several sites of country holiday homes and volunteer organizations, sometimes I engaged in these sites.</p>
            <p className={styles.p}>
                <b>php</b> used as the back-end, <b>javascript</b> was on the front, mixed with <b>jQuery</b>.
                I was one front-end developer, so some global modules and improvements given to outsourcing.
            ...
            <p className={styles.p}>
                ...
                After a while, I assigned to create a mini-game "Crossword Puzzle" to get a discount, which I successfully solved with <b>vue</b>.
                Interestingly, they still use <a href="//www.bkc.ru/landing/crossword" target="_blank" className={styles.link}>this game</a>!
                Of course, the design has already changed, but I recognize my css classes in the BEM style.
            </p>
        </div>
    )
};