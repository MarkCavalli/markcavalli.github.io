      ...
      <section className={styles.main}>
        ...
        <ContentItem title="Details">
          <p className={styles.infoText}>
            Hello! My name is Aleksei Osinnii. Do not be confused with Mark Cavalli everywhere, it's just a nickname.
            Frontend is the first thing a user sees when visiting your website. It is critically important to pay attention to all the little things,
            after all, the user's first impression of your company depends on it. According to statistics, 53% of users will leave the website if it loads for more than 3 seconds.
          </p>
          <p className={styles.infoText}>
            I put forward increased demands on my work. I use a monitor with a frequency of 144 hz (6 mspersecond), instead of the usual 60 hz (16 ms per second).
            This means that in order to maintain the smoothness of the image, the code must run almost 3 times faster than usual. Of course, there are few users with 144 hz,
